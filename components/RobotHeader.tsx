...
const RobotHeader = () => {
  return (
    <Card className="w-full sm:h-[500px] h-[600px] bg-[#27391C]/[0.96] relative overflow-hidden">
      ...
      <div className="flex h-full sm:flex-row flex-col ">
        <div className="flex-1 p-8 sm:pt-0 pt-15 relative z-10 flex flex-col justify-center items-center">
          <h1 className="text-3xl md:text-5xl font-bold bg-clip-text text-[#FFCF50] bg-gradient-to-b from-neutral-50 to-neutral-400">
            Busy Mind Concept
          </h1>
